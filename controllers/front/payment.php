<?php
class paymentprestashopPaymentModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $redirecturl = $this->context->link->getPageLink('index',true).'module/paymentprestashop/redirecturl.php';
