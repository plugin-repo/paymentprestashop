...
<p class="payment_module">
	...
	<form name="myForm" onsubmit="" action="{$link->getModuleLink('paymentprestashop', 'validation', [], true)|escape:'html'}" method="post" class="form-horizontal" id="paymentprestashopForm">
		<img src="{$this_path_bw}logo.jpg" alt="{l s='Pay by Cloud 10' mod='paymentprestashop'}"/>
		<span class="payment-heading">{l s='Pay by Cloud 10' mod='paymentprestashop'}</span>
		

			<div class="selection">
			<div class="payment-type">
			<span><label for="paymenttype" class="col-sm-3 control-label">{l s="No payment method found." mod='paymentprestashop'} </label></span>
