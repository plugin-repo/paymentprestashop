...
<img src="../modules/paymentprestashop/logo.png" style="float:left; margin-right:15px; margin-top:-10px;"  width="200" height="70">
...
<!--
		<div class="form-group">
			...
			<div class="col-lg-9">
				...
				<p class="help-block"> {l s="Enter partner id provided by Paymentprestashop"} </p>
			</div>
		</div>	
-->
