...
<p class="alert alert-warning">{l s='Thank you for shopping with us. However, the transaction has been cancelled.' mod='paymentprestashop'}</p>

<div id="mymodule_block_home" class="box cheque-box" >
	<p>{l s='Your order has been Cancelled.' sprintf=$shop_name mod='paymentprestashop'}
