...
<p class="alert alert-success">{l s='Thank you for shopping with us. Your credit card has been charged and your transaction is successful. We will be shipping your order to you soon.' mod='paymentprestashop'}</p>
<div id="mymodule_block_home" class="box cheque-box" >
	<p>
		{l s='Your order is successful.' sprintf=$shop_name mod='paymentprestashop'}
			<br/>- {l s='Amount' mod='paymentprestashop'} <span class="price"><strong>{displayPrice price=$amount}</strong></span>
			<br/>- {l s='Order refrence code is:' mod='paymentprestashop'}<span>{$desc}</span>
			<br/> <strong>{l s='Your order will be sent as soon as we receive payment.' mod='paymentprestashop'}</strong>
